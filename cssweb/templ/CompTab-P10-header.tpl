...
<title>Совместимость с дистрибутивами Альт на десятой платформе</title>
...
<p class="notes">Совместимость с уже устаревшими дистрибутивами Альт на <b>девятой платформе</b> и
   ...
   обращайтесь в <a href="mailto:sales@basealt.ru" title="Отправить запрос">отдел продаж</a>.

   Скачать инструкции для P10 по настройке поддерживаемых токенов/смарт-карт
   и доменной двухфакторной аутентификации (2ФА) можно прямо здесь: 1)
   <a href="instr/335844b414254180f123dbb5d83caf4d.pdf" title="Открыть PDF" target="_blank">Настройка
   2ФА: общая теоретическая часть</a>; 2)
   <a href="instr/255bec169a5c488c8311ef732188f4ed.pdf" title="Открыть PDF" target="_blank">Настройка
   2ФА в домене на основе Samba DC</a>; 3)
   <a href="instr/1a041e4d0fed96161033d23beec80639.pdf" title="Открыть PDF" target="_blank">Настройка
   в домене на основе FreeIPA</a>; 4)
   <a href="instr/a8cf6bfd1fc23aa82e4d22b845e3122a.pdf" title="Открыть PDF" target="_blank">Настройка
   в домене на основе Windows AD</a>.
   Аналогичные инструкции для «Альт 8 СП» можно запросить в отделе продаж.</p>
</div>
