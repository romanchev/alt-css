...
<title>Совместимость с устаревшими дистрибутивами Альт 8 СП (не обновляется)</title>
...
.notes { margin:20px; padding:20px 60px; font-size:120%; font-style:italic; background:#fcc; color:#000; border:1px solid #000; border-radius:5px; box-shadow:3px 3px 6px rgba(0,0,0,0.2); }
...
<td><h1>Совместимость с устаревшими дистрибутивами Альт 8 СП</h1>
...
<div>
<p class="notes">Здесь представлена информация о совместимости с дистрибутивом «<b>Альт 8 СП</b>»
